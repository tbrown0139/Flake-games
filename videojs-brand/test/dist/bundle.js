...
_qunit2['default'].module('videojs-brand', {
...
_qunit2['default'].test('registers itself with video.js', function (assert) {
  ...
  assert.strictEqual(Player.prototype.brand, _srcPlugin2['default'], 'videojs-brand plugin was registered');
  ...
  assert.ok(this.player.hasClass('vjs-brand'), 'the plugin adds a class to the player');
});
